...
export async function generateInvoicePDF(order, settings) {
  ...
  if (stampData) {
    try {
      ...
      // the "for AK Enterprises" heading (tableY+24) and the signature line (tableY+40),
      // lightly crossing the line without touching "Authorised Signatory" (tableY+43)
      doc.addImage(
      ...
      console.error('Failed to add stamp image to invoice PDF:', e.message)
    }
  }
