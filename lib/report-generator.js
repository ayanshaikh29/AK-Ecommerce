...
export function buildReportData(orders, opts = {}) {
  ...
  orderList.forEach(o => {
    const clientName = o.customer_profile?.business_name || o.customer_profile?.company_name || o.addresses?.business_name || o.addresses?.full_name || o.customer_profile?.full_name || 'Unknown'
  ...
  return {
    ...
    orders: orderList.map(o => ({
      ...
      date: o.placed_at,
      customer: o.customer_profile?.business_name || o.customer_profile?.company_name || o.addresses?.business_name || o.addresses?.full_name || o.customer_profile?.full_name || 'Guest',
