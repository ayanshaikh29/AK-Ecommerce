 ...
 */
export const downloadInvoice = (order, isVendor = false) => {
            ...
            <tr>
              <td style="vertical-align:top; width:55%; padding-right:20px;">
                ...
                <div style="font-size:10.5px; color:#4B5563; line-height:1.7;">
                  ...
                  ${order.address?.line1 || ''}${order.address?.line2 && order.address.line2 !== order.address.line1 ? '<br/>' + order.address.line2 : ''}<br/>
          ...
          <table width="100%" style="border-collapse:collapse; margin-bottom:18px;">
            <thead>
              <tr style="background:#500713;">
                ${isVendor ? `
                  <th style="${thStyle}width:80%;">Item Description</th>
                  <th style="${thStyle}text-align:center; width:20%;">Qty</th>
                ` : `
