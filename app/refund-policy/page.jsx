...
export const metadata = {
  title: 'Refund & Return Policy | AK Enterprises',
}

export default async function RefundPolicyPage() {
  const settings = await getSettings()
  const content = settings?.policy_refund || 'Refund & return policy content is currently empty. Manage this text in Site Settings.'

  return (
    <div className="max-w-4xl mx-auto px-4 py-16 slide-up">
      <div className="text-center mb-12">
        <h1 className="font-display text-4xl font-extrabold mb-4 text-primary">Refund & Return Policy</h1>
